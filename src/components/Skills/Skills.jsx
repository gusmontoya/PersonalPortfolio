            ...
            {activeLayer.title === 'None' && (
              <Fade left={isDesktop} bottom={isMobile} duration={500} delay={250} distance="30px">
                <div className="skills-wrapper__info">
                  <h3 className="skills-wrapper__info-text">"Apps are alot like burgers. They've are made with layers of different components." <span className="small">(rumored)</span></h3>
